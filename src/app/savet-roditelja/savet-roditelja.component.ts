...
@Component({
  selector: 'app-savet-roditelja',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './savet-roditelja.component.html',
  styleUrl: './savet-roditelja.component.css'
})
export class SavetRoditeljaComponent implements OnInit {
  @ViewChild('top') top!: ElementRef; 
  personForm: FormGroup;
  personList: Person[] = [];
  selectedPerson: Person | null = null;
  type: PersonType = PersonType.SAVET_RODITELJA;
