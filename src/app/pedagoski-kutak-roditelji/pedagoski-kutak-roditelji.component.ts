...
@Component({
  selector: 'app-pedagoski-kutak-roditelji',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink],
  templateUrl: './pedagoski-kutak-roditelji.component.html',
  styleUrl: './pedagoski-kutak-roditelji.component.css'
})
export class PedagoskiKutakRoditeljiComponent implements OnInit {
  postPage: PostPage = {
    totalElements: 0,
    totalPages: 0,
    first: true,
  ...
  loadNews(): void {
      this.postService.getAllRoditeljiPosts( this.currentPage, this.pageSize, this.sortBy, this.sortDir, this.searchTerm).subscribe(postPage => {
